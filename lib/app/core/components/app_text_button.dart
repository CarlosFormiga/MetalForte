...
import 'package:metal_forte/app/core/components/app_shimmer.dart';
import 'package:metal_forte/app/core/enums/fill.dart';
  ...
  ButtonStyle get style {
    if (widget.style != null) {
      return widget.style!.copyWith(
          fixedSize:
              const WidgetStatePropertyAll(Size(double.maxFinite, 43)));
    }
